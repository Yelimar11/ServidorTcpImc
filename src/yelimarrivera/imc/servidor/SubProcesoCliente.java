 ...
 */
package yelimarrivera.imc.servidor;
...
import yelimarrivera.imc.modelo.CalculoImc;
import yelimarrivera.imc.vistas.VentanaPrincipal;
...
public class SubProcesoCliente extends Thread {
    ...
    public String log() {
        SimpleDateFormat f = new SimpleDateFormat("dd-MM-yyyyy hh:mm:ss a");
